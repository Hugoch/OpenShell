...
| Large Git push fails after ownership transfer | Owned stage used fail-open, exceeded its 1 GiB deferred bound, returned noncontiguous output, or reported incorrect final accounting | Require `fail_closed`; inspect input/output sequences, `body_finalize`, spool capacity, and service logs |
