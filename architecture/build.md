...
dedicated sandbox-lifecycle scenarios verify stop/start persistence and bound a
two-sandbox startup burst that checks relay attachments across the supervisor's
initial reconnect. The guest runs at most two archive tests concurrently. The
