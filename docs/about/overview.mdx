...
For details, refer to [Configure Sandbox Policies](/sandboxes/policies) and [Default Policy](/reference/default-policy).
...
- To learn how OpenShell enforces policy controls across protection layers, refer to [Configure Sandbox Policies](/sandboxes/policies).
