...
process. If your attachment owns stdin, `Ctrl-C` interrupts the foreground
process. In a read-only attachment, `Ctrl-C` exits the viewer and leaves the
main process and other attachments running.
