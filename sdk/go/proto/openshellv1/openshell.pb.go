...
type CpuResourceCapabilities struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// The driver accepts a portable CPU quantity.
	QuantitySupported bool `protobuf:"varint,1,opt,name=quantity_supported,json=quantitySupported,proto3" json:"quantity_supported,omitempty"`
	unknownFields     protoimpl.UnknownFields
	sizeCache         protoimpl.SizeCache
}
...
func (x *CpuResourceCapabilities) GetQuantitySupported() bool {
	if x != nil {
		return x.QuantitySupported
	}
	return false
}
...
type MemoryResourceCapabilities struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// The driver accepts a portable memory quantity.
	QuantitySupported bool `protobuf:"varint,1,opt,name=quantity_supported,json=quantitySupported,proto3" json:"quantity_supported,omitempty"`
	unknownFields     protoimpl.UnknownFields
	sizeCache         protoimpl.SizeCache
}
...
func (x *MemoryResourceCapabilities) GetQuantitySupported() bool {
	if x != nil {
		return x.QuantitySupported
	}
	return false
...
type CpuResourceRequirements struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Portable CPU quantity for the sandbox workload (e.g. "500m", "2").
	Quantity      *string `protobuf:"bytes,1,opt,name=quantity,proto3,oneof" json:"quantity,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *CpuResourceRequirements) GetQuantity() string {
...
type MemoryResourceRequirements struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Portable memory quantity for the sandbox workload (e.g. "512Mi", "4Gi").
	Quantity      *string `protobuf:"bytes,1,opt,name=quantity,proto3,oneof" json:"quantity,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *MemoryResourceRequirements) GetQuantity() string {
	if x != nil && x.Quantity != nil {
		return *x.Quantity
	}
	return ""
...
type SandboxWorkloadConfig struct {
	...
	// Legacy resource requirements retained only to decode templates persisted
	// before ResourceRequirements became the shared portable resource model.
	//
	// Deprecated: Marked as deprecated in openshell.proto.
	LegacyResources *LegacySandboxResources `protobuf:"bytes,3,opt,name=legacy_resources,json=legacyResources,proto3" json:"legacy_resources,omitempty"`
...
// Deprecated: Marked as deprecated in openshell.proto.
func (x *SandboxWorkloadConfig) GetLegacyResources() *LegacySandboxResources {
	if x != nil {
		return x.LegacyResources
	}
	return nil
}
...
// Legacy persisted resource shape. New API writes must not populate this
// message; the gateway converts it to ResourceRequirements when loading stored
// workload templates.
type LegacySandboxResources struct {
	state         protoimpl.MessageState   `protogen:"open.v1"`
...
func (x *LegacySandboxResources) Reset() {
	*x = LegacySandboxResources{}
	mi := &file_openshell_proto_msgTypes[26]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *LegacySandboxResources) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*LegacySandboxResources) ProtoMessage() {}

func (x *LegacySandboxResources) ProtoReflect() protoreflect.Message {
	mi := &file_openshell_proto_msgTypes[26]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use LegacySandboxResources.ProtoReflect.Descriptor instead.
func (*LegacySandboxResources) Descriptor() ([]byte, []int) {
	return file_openshell_proto_rawDescGZIP(), []int{26}
}

func (x *LegacySandboxResources) GetCpu() string {
	if x != nil {
		return x.Cpu
	}
	return ""
...
func (x *LegacySandboxResources) GetMemory() string {
	if x != nil {
		return x.Memory
	}
	return ""
...
func (x *LegacySandboxResources) GetGpu() *GpuResourceRequirements {
	if x != nil {
		return x.Gpu
	}
	return nil
...
const file_openshell_proto_rawDesc = "" +
	...
	"\x03gpu\x18\x03 \x01(\v2%.openshell.v1.GpuResourceCapabilitiesR\x03gpu\"H\n" +
	"\x17CpuResourceCapabilities\x12-\n" +
	"\x12quantity_supported\x18\x01 \x01(\bR\x11quantitySupported\"K\n" +
	"\x1aMemoryResourceCapabilities\x12-\n" +
	"\x12quantity_supported\x18\x01 \x01(\bR\x11quantitySupported\"\x95\x01\n" +
	...
	"\x06_count\"G\n" +
	"\x17CpuResourceRequirements\x12\x1f\n" +
	"\bquantity\x18\x01 \x01(\tH\x00R\bquantity\x88\x01\x01B\v\n" +
	"\t_quantity\"J\n" +
	"\x1aMemoryResourceRequirements\x12\x1f\n" +
	"\bquantity\x18\x01 \x01(\tH\x00R\bquantity\x88\x01\x01B\v\n" +
	"\t_quantity\"\xef\x05\n" +
	...
	"\x15desired_service_level\x18\x03 \x01(\v2!.openshell.v1.SandboxServiceLevelR\x13desiredServiceLevel\"\xdc\x02\n" +
	"\x15SandboxWorkloadConfig\x12\x14\n" +
	"\x05image\x18\x01 \x01(\tR\x05image\x12V\n" +
	"\venvironment\x18\x02 \x03(\v24.openshell.v1.SandboxWorkloadConfig.EnvironmentEntryR\venvironment\x12S\n" +
	"\x10legacy_resources\x18\x03 \x01(\v2$.openshell.v1.LegacySandboxResourcesB\x02\x18\x01R\x0flegacyResources\x12@\n" +
	"\tresources\x18\x04 \x01(\v2\".openshell.v1.ResourceRequirementsR\tresources\x1a>\n" +
	"\x10EnvironmentEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01\"{\n" +
	"\x16LegacySandboxResources\x12\x10\n" +
...
var file_openshell_proto_goTypes = []any{
	...
	(*CpuResourceRequirements)(nil),                      // 37: openshell.v1.CpuResourceRequirements
	(*MemoryResourceRequirements)(nil),                   // 38: openshell.v1.MemoryResourceRequirements
	...
	(*LegacySandboxResources)(nil),                       // 43: openshell.v1.LegacySandboxResources
	...
	nil,                                                  // 246: openshell.v1.SandboxSpec.EnvironmentEntry
	nil,                                                  // 247: openshell.v1.SandboxTemplate.LabelsEntry
	nil,                                                  // 248: openshell.v1.SandboxTemplate.AnnotationsEntry
	nil,                                                  // 249: openshell.v1.SandboxTemplate.EnvironmentEntry
	nil,                                                  // 250: openshell.v1.SandboxWorkloadConfig.EnvironmentEntry
	nil,                                                  // 251: openshell.v1.PlatformEvent.MetadataEntry
	nil,                                                  // 252: openshell.v1.CreateSandboxRequest.LabelsEntry
	nil,                                                  // 253: openshell.v1.CreateSandboxRequest.AnnotationsEntry
...
var file_openshell_proto_depIdxs = []int32{
	...
	246, // 16: openshell.v1.SandboxSpec.environment:type_name -> openshell.v1.SandboxSpec.EnvironmentEntry
	...
	37,  // 21: openshell.v1.ResourceRequirements.cpu:type_name -> openshell.v1.CpuResourceRequirements
	38,  // 22: openshell.v1.ResourceRequirements.memory:type_name -> openshell.v1.MemoryResourceRequirements
	247, // 23: openshell.v1.SandboxTemplate.labels:type_name -> openshell.v1.SandboxTemplate.LabelsEntry
	248, // 24: openshell.v1.SandboxTemplate.annotations:type_name -> openshell.v1.SandboxTemplate.AnnotationsEntry
	249, // 25: openshell.v1.SandboxTemplate.environment:type_name -> openshell.v1.SandboxTemplate.EnvironmentEntry
	270, // 26: openshell.v1.SandboxTemplate.resources:type_name -> google.protobuf.Struct
	270, // 27: openshell.v1.SandboxTemplate.driver_config:type_name -> google.protobuf.Struct
	268, // 28: openshell.v1.SandboxWorkloadTemplate.metadata:type_name -> openshell.datamodel.v1.ObjectMeta
	...
	270, // 31: openshell.v1.SandboxWorkloadTemplateSpec.driver_config:type_name -> google.protobuf.Struct
	44,  // 32: openshell.v1.SandboxWorkloadTemplateSpec.desired_service_level:type_name -> openshell.v1.SandboxServiceLevel
	250, // 33: openshell.v1.SandboxWorkloadConfig.environment:type_name -> openshell.v1.SandboxWorkloadConfig.EnvironmentEntry
	43,  // 34: openshell.v1.SandboxWorkloadConfig.legacy_resources:type_name -> openshell.v1.LegacySandboxResources
	35,  // 35: openshell.v1.SandboxWorkloadConfig.resources:type_name -> openshell.v1.ResourceRequirements
	36,  // 36: openshell.v1.LegacySandboxResources.gpu:type_name -> openshell.v1.GpuResourceRequirements
	45,  // 37: openshell.v1.SandboxServiceLevel.startup:type_name -> openshell.v1.SandboxStartup
	271, // 38: openshell.v1.SandboxStartup.ready_within:type_name -> google.protobuf.Duration
	48,  // 39: openshell.v1.SandboxStatus.conditions:type_name -> openshell.v1.SandboxCondition
	0,   // 40: openshell.v1.SandboxStatus.phase:type_name -> openshell.v1.SandboxPhase
	244, // 41: openshell.v1.SandboxStatus.endpoint_statuses:type_name -> openshell.v1.EndpointStatus
	173, // 42: openshell.v1.SandboxStatus.configuration_admission:type_name -> openshell.v1.SandboxConfigurationAdmission
	245, // 43: openshell.v1.SandboxStatus.provisioning:type_name -> openshell.v1.SandboxProvisioning
	267, // 44: openshell.v1.SandboxCondition.transition_time:type_name -> google.protobuf.Timestamp
	267, // 45: openshell.v1.PlatformEvent.event_time:type_name -> google.protobuf.Timestamp
	251, // 46: openshell.v1.PlatformEvent.metadata:type_name -> openshell.v1.PlatformEvent.MetadataEntry
	34,  // 47: openshell.v1.CreateSandboxRequest.spec:type_name -> openshell.v1.SandboxSpec
	252, // 48: openshell.v1.CreateSandboxRequest.labels:type_name -> openshell.v1.CreateSandboxRequest.LabelsEntry
	253, // 49: openshell.v1.CreateSandboxRequest.annotations:type_name -> openshell.v1.CreateSandboxRequest.AnnotationsEntry
	272, // 50: openshell.v1.CreateSandboxRequest.workspace_scope:type_name -> openshell.datamodel.v1.WorkspaceSelector
	40,  // 51: openshell.v1.CreateSandboxTemplateRequest.template:type_name -> openshell.v1.SandboxWorkloadTemplate
	272, // 52: openshell.v1.CreateSandboxTemplateRequest.workspace_scope:type_name -> openshell.datamodel.v1.WorkspaceSelector
	272, // 53: openshell.v1.GetSandboxTemplateRequest.workspace_scope:type_name -> openshell.datamodel.v1.WorkspaceSelector
	272, // 54: openshell.v1.ListSandboxTemplatesRequest.workspace_scope:type_name -> openshell.datamodel.v1.WorkspaceSelector
	272, // 55: openshell.v1.DeleteSandboxTemplateRequest.workspace_scope:type_name -> openshell.datamodel.v1.WorkspaceSelector
	...
	15,  // 58: openshell.v1.DeleteSandboxTemplateResponse.outcome:type_name -> openshell.v1.DeletionOutcome
	272, // 59: openshell.v1.BeginRootfsTarStagingRequest.workspace_scope:type_name -> openshell.datamodel.v1.WorkspaceSelector
	267, // 60: openshell.v1.BeginRootfsTarStagingResponse.expiration_time:type_name -> google.protobuf.Timestamp
	272, // 61: openshell.v1.GetSandboxRequest.workspace_scope:type_name -> openshell.datamodel.v1.WorkspaceSelector
	272, // 62: openshell.v1.ListSandboxesRequest.workspace_scope:type_name -> openshell.datamodel.v1.WorkspaceSelector
	272, // 63: openshell.v1.ListSandboxProvidersRequest.workspace_scope:type_name -> openshell.datamodel.v1.WorkspaceSelector
	272, // 64: openshell.v1.AttachSandboxProviderRequest.workspace_scope:type_name -> openshell.datamodel.v1.WorkspaceSelector
	272, // 65: openshell.v1.DetachSandboxProviderRequest.workspace_scope:type_name -> openshell.datamodel.v1.WorkspaceSelector
	272, // 66: openshell.v1.DeleteSandboxRequest.workspace_scope:type_name -> openshell.datamodel.v1.WorkspaceSelector
	272, // 67: openshell.v1.StopSandboxRequest.workspace_scope:type_name -> openshell.datamodel.v1.WorkspaceSelector
	272, // 68: openshell.v1.StartSandboxRequest.workspace_scope:type_name -> openshell.datamodel.v1.WorkspaceSelector
	33,  // 69: openshell.v1.SandboxResponse.sandbox:type_name -> openshell.v1.Sandbox
	33,  // 70: openshell.v1.ListSandboxesResponse.sandboxes:type_name -> openshell.v1.Sandbox
	273, // 71: openshell.v1.ListSandboxProvidersResponse.providers:type_name -> openshell.datamodel.v1.Provider
	33,  // 72: openshell.v1.AttachSandboxProviderResponse.sandbox:type_name -> openshell.v1.Sandbox
	77,  // 73: openshell.v1.AttachSandboxProviderResponse.receipt:type_name -> openshell.v1.ProviderMutationReceipt
	33,  // 74: openshell.v1.DetachSandboxProviderResponse.sandbox:type_name -> openshell.v1.Sandbox
	77,  // 75: openshell.v1.DetachSandboxProviderResponse.receipt:type_name -> openshell.v1.ProviderMutationReceipt
	75,  // 76: openshell.v1.ConfigSnapshotRevision.sandbox_config:type_name -> openshell.v1.SandboxConfigRevision
	73,  // 77: openshell.v1.ConfigSnapshotRevision.provider_target:type_name -> openshell.v1.ProviderDesiredIdentity
	274, // 78: openshell.v1.SandboxConfigRevision.policy_source:type_name -> openshell.sandbox.v1.PolicySource
	4,   // 79: openshell.v1.ConfigUpdateOperation.component:type_name -> openshell.v1.ConfigComponent
	74,  // 80: openshell.v1.ConfigUpdateOperation.target_revision:type_name -> openshell.v1.ConfigSnapshotRevision
	6,   // 81: openshell.v1.ConfigUpdateOperation.state:type_name -> openshell.v1.ConfigUpdateOperationState
	5,   // 82: openshell.v1.ConfigUpdateOperation.outcome:type_name -> openshell.v1.ConfigApplyOutcome
	267, // 83: openshell.v1.ConfigUpdateOperation.created_time:type_name -> google.protobuf.Timestamp
	267, // 84: openshell.v1.ConfigUpdateOperation.updated_time:type_name -> google.protobuf.Timestamp
	267, // 85: openshell.v1.ConfigUpdateOperation.completed_time:type_name -> google.protobuf.Timestamp
	1,   // 86: openshell.v1.ProviderMutationReceipt.kind:type_name -> openshell.v1.ProviderMutationKind
	73,  // 87: openshell.v1.ProviderMutationReceipt.desired:type_name -> openshell.v1.ProviderDesiredIdentity
	267, // 88: openshell.v1.ProviderMutationReceipt.persisted_time:type_name -> google.protobuf.Timestamp
	3,   // 89: openshell.v1.ProviderReadinessObservation.reason:type_name -> openshell.v1.ProviderReadinessReason
	77,  // 90: openshell.v1.ProviderReadinessStatus.receipt:type_name -> openshell.v1.ProviderMutationReceipt
	2,   // 91: openshell.v1.ProviderReadinessStatus.state:type_name -> openshell.v1.ProviderReadinessState
	3,   // 92: openshell.v1.ProviderReadinessStatus.reason:type_name -> openshell.v1.ProviderReadinessReason
	78,  // 93: openshell.v1.ProviderReadinessStatus.observed:type_name -> openshell.v1.ProviderReadinessObservation
	267, // 94: openshell.v1.ProviderReadinessStatus.observed_time:type_name -> google.protobuf.Timestamp
	267, // 95: openshell.v1.ProviderReadinessStatus.evaluated_time:type_name -> google.protobuf.Timestamp
	76,  // 96: openshell.v1.ProviderReadinessStatus.operation:type_name -> openshell.v1.ConfigUpdateOperation
	272, // 97: openshell.v1.GetSandboxProviderStatusRequest.workspace_scope:type_name -> openshell.datamodel.v1.WorkspaceSelector
	79,  // 98: openshell.v1.GetSandboxProviderStatusResponse.status:type_name -> openshell.v1.ProviderReadinessStatus
	78,  // 99: openshell.v1.ReportProviderReadinessRequest.observation:type_name -> openshell.v1.ProviderReadinessObservation
	271, // 100: openshell.v1.ReportProviderReadinessResponse.report_interval:type_name -> google.protobuf.Duration
	271, // 101: openshell.v1.ReportProviderReadinessResponse.observation_ttl:type_name -> google.protobuf.Duration
	15,  // 102: openshell.v1.DeleteSandboxResponse.outcome:type_name -> openshell.v1.DeletionOutcome
	...
	254, // 113: openshell.v1.ExecSandboxRequest.environment:type_name -> openshell.v1.ExecSandboxRequest.EnvironmentEntry
	271, // 114: openshell.v1.ExecSandboxRequest.execution_timeout:type_name -> google.protobuf.Duration
	98,  // 115: openshell.v1.ExecSandboxEvent.stdout:type_name -> openshell.v1.ExecSandboxStdout
	99,  // 116: openshell.v1.ExecSandboxEvent.stderr:type_name -> openshell.v1.ExecSandboxStderr
	100, // 117: openshell.v1.ExecSandboxEvent.exit:type_name -> openshell.v1.ExecSandboxExit
	193, // 118: openshell.v1.TcpForwardInit.ssh:type_name -> openshell.v1.SshRelayTarget
	194, // 119: openshell.v1.TcpForwardInit.tcp:type_name -> openshell.v1.TcpRelayTarget
	102, // 120: openshell.v1.TcpForwardFrame.init:type_name -> openshell.v1.TcpForwardInit
	97,  // 121: openshell.v1.ExecSandboxInput.start:type_name -> openshell.v1.ExecSandboxRequest
	105, // 122: openshell.v1.ExecSandboxInput.resize:type_name -> openshell.v1.ExecSandboxWindowResize
	268, // 123: openshell.v1.SshSession.metadata:type_name -> openshell.datamodel.v1.ObjectMeta
	267, // 124: openshell.v1.SshSession.expiration_time:type_name -> google.protobuf.Timestamp
	267, // 125: openshell.v1.WatchSandboxRequest.since_time:type_name -> google.protobuf.Timestamp
	...
	204, // 130: openshell.v1.SandboxStreamEvent.draft_policy_update:type_name -> openshell.v1.DraftPolicyUpdate
	267, // 131: openshell.v1.SandboxLogLine.event_time:type_name -> google.protobuf.Timestamp
	255, // 132: openshell.v1.SandboxLogLine.fields:type_name -> openshell.v1.SandboxLogLine.FieldsEntry
	273, // 133: openshell.v1.CreateProviderRequest.provider:type_name -> openshell.datamodel.v1.Provider
	272, // 134: openshell.v1.CreateProviderRequest.workspace_scope:type_name -> openshell.datamodel.v1.WorkspaceSelector
	272, // 135: openshell.v1.GetProviderRequest.workspace_scope:type_name -> openshell.datamodel.v1.WorkspaceSelector
	272, // 136: openshell.v1.ListProvidersRequest.workspace_scope:type_name -> openshell.datamodel.v1.WorkspaceSelector
	273, // 137: openshell.v1.UpdateProviderRequest.provider:type_name -> openshell.datamodel.v1.Provider
	256, // 138: openshell.v1.UpdateProviderRequest.credential_expiration_times:type_name -> openshell.v1.UpdateProviderRequest.CredentialExpirationTimesEntry
	272, // 139: openshell.v1.UpdateProviderRequest.workspace_scope:type_name -> openshell.datamodel.v1.WorkspaceSelector
	272, // 140: openshell.v1.DeleteProviderRequest.workspace_scope:type_name -> openshell.datamodel.v1.WorkspaceSelector
	273, // 141: openshell.v1.ProviderResponse.provider:type_name -> openshell.datamodel.v1.Provider
	77,  // 142: openshell.v1.ProviderResponse.target_receipts:type_name -> openshell.v1.ProviderMutationReceipt
	273, // 143: openshell.v1.ListProvidersResponse.providers:type_name -> openshell.datamodel.v1.Provider
	139, // 144: openshell.v1.ProviderProfileImportItem.profile:type_name -> openshell.v1.ProviderProfile
	271, // 145: openshell.v1.ProviderCredentialTokenGrant.cache_ttl:type_name -> google.protobuf.Duration
	122, // 146: openshell.v1.ProviderCredentialTokenGrant.audience_overrides:type_name -> openshell.v1.ProviderCredentialTokenGrantAudienceOverride
	7,   // 147: openshell.v1.ProviderCredentialTokenGrant.grant_type:type_name -> openshell.v1.ProviderCredentialTokenGrantType
	123, // 148: openshell.v1.ProviderCredentialTokenGrant.subject_token:type_name -> openshell.v1.ProviderCredentialTokenGrantSubjectToken
	128, // 149: openshell.v1.ProviderProfileCredential.refresh:type_name -> openshell.v1.ProviderCredentialRefresh
	124, // 150: openshell.v1.ProviderProfileCredential.token_grant:type_name -> openshell.v1.ProviderCredentialTokenGrant
	8,   // 151: openshell.v1.ProviderCredentialRefresh.strategy:type_name -> openshell.v1.ProviderCredentialRefreshStrategy
	271, // 152: openshell.v1.ProviderCredentialRefresh.refresh_before:type_name -> google.protobuf.Duration
	271, // 153: openshell.v1.ProviderCredentialRefresh.max_lifetime:type_name -> google.protobuf.Duration
	126, // 154: openshell.v1.ProviderCredentialRefresh.material:type_name -> openshell.v1.ProviderCredentialRefreshMaterial
	127, // 155: openshell.v1.ProviderCredentialRefresh.additional_outputs:type_name -> openshell.v1.ProviderCredentialRefreshOutput
	8,   // 156: openshell.v1.ProviderCredentialRefreshStatus.strategy:type_name -> openshell.v1.ProviderCredentialRefreshStrategy
	267, // 157: openshell.v1.ProviderCredentialRefreshStatus.expiration_time:type_name -> google.protobuf.Timestamp
	267, // 158: openshell.v1.ProviderCredentialRefreshStatus.next_refresh_time:type_name -> google.protobuf.Timestamp
	267, // 159: openshell.v1.ProviderCredentialRefreshStatus.last_refresh_time:type_name -> google.protobuf.Timestamp
	14,  // 160: openshell.v1.ProviderCredentialRefreshStatus.recovery_action:type_name -> openshell.v1.ProviderCredentialRefreshRecoveryAction
	267, // 161: openshell.v1.ProviderCredentialRefreshStatus.last_error_time:type_name -> google.protobuf.Timestamp
	272, // 162: openshell.v1.GetProviderRefreshStatusRequest.workspace_scope:type_name -> openshell.datamodel.v1.WorkspaceSelector
	129, // 163: openshell.v1.GetProviderRefreshStatusResponse.credentials:type_name -> openshell.v1.ProviderCredentialRefreshStatus
	8,   // 164: openshell.v1.ConfigureProviderRefreshRequest.strategy:type_name -> openshell.v1.ProviderCredentialRefreshStrategy
	257, // 165: openshell.v1.ConfigureProviderRefreshRequest.material:type_name -> openshell.v1.ConfigureProviderRefreshRequest.MaterialEntry
	267, // 166: openshell.v1.ConfigureProviderRefreshRequest.expiration_time:type_name -> google.protobuf.Timestamp
	272, // 167: openshell.v1.ConfigureProviderRefreshRequest.workspace_scope:type_name -> openshell.datamodel.v1.WorkspaceSelector
	129, // 168: openshell.v1.ConfigureProviderRefreshResponse.status:type_name -> openshell.v1.ProviderCredentialRefreshStatus
	272, // 169: openshell.v1.RotateProviderCredentialRequest.workspace_scope:type_name -> openshell.datamodel.v1.WorkspaceSelector
	129, // 170: openshell.v1.RotateProviderCredentialResponse.status:type_name -> openshell.v1.ProviderCredentialRefreshStatus
	272, // 171: openshell.v1.DeleteProviderRefreshRequest.workspace_scope:type_name -> openshell.datamodel.v1.WorkspaceSelector
	15,  // 172: openshell.v1.DeleteProviderRefreshResponse.outcome:type_name -> openshell.v1.DeletionOutcome
	9,   // 173: openshell.v1.ProviderProfile.category:type_name -> openshell.v1.ProviderProfileCategory
	125, // 174: openshell.v1.ProviderProfile.credentials:type_name -> openshell.v1.ProviderProfileCredential
	275, // 175: openshell.v1.ProviderProfile.endpoints:type_name -> openshell.sandbox.v1.NetworkEndpoint
	276, // 176: openshell.v1.ProviderProfile.binaries:type_name -> openshell.sandbox.v1.NetworkBinary
	130, // 177: openshell.v1.ProviderProfile.discovery:type_name -> openshell.v1.ProviderProfileDiscovery
	258, // 178: openshell.v1.ProviderProfile.annotations:type_name -> openshell.v1.ProviderProfile.AnnotationsEntry
	139, // 179: openshell.v1.ProviderProfileResponse.profile:type_name -> openshell.v1.ProviderProfile
	139, // 180: openshell.v1.ListProviderProfilesResponse.profiles:type_name -> openshell.v1.ProviderProfile
	120, // 181: openshell.v1.ImportProviderProfilesRequest.profiles:type_name -> openshell.v1.ProviderProfileImportItem
	121, // 182: openshell.v1.ImportProviderProfilesResponse.diagnostics:type_name -> openshell.v1.ProviderProfileDiagnostic
	139, // 183: openshell.v1.ImportProviderProfilesResponse.profiles:type_name -> openshell.v1.ProviderProfile
	120, // 184: openshell.v1.UpdateProviderProfilesRequest.profile:type_name -> openshell.v1.ProviderProfileImportItem
	121, // 185: openshell.v1.UpdateProviderProfilesResponse.diagnostics:type_name -> openshell.v1.ProviderProfileDiagnostic
	139, // 186: openshell.v1.UpdateProviderProfilesResponse.profile:type_name -> openshell.v1.ProviderProfile
	120, // 187: openshell.v1.LintProviderProfilesRequest.profiles:type_name -> openshell.v1.ProviderProfileImportItem
	121, // 188: openshell.v1.LintProviderProfilesResponse.diagnostics:type_name -> openshell.v1.ProviderProfileDiagnostic
	15,  // 189: openshell.v1.DeleteProviderResponse.outcome:type_name -> openshell.v1.DeletionOutcome
	15,  // 190: openshell.v1.DeleteProviderProfileResponse.outcome:type_name -> openshell.v1.DeletionOutcome
	152, // 191: openshell.v1.StaticCredentialBinding.endpoints:type_name -> openshell.v1.StaticCredentialEndpointBinding
	259, // 192: openshell.v1.GetSandboxProviderEnvironmentResponse.environment:type_name -> openshell.v1.GetSandboxProviderEnvironmentResponse.EnvironmentEntry
	260, // 193: openshell.v1.GetSandboxProviderEnvironmentResponse.credential_expiration_times:type_name -> openshell.v1.GetSandboxProviderEnvironmentResponse.CredentialExpirationTimesEntry
	261, // 194: openshell.v1.GetSandboxProviderEnvironmentResponse.dynamic_credentials:type_name -> openshell.v1.GetSandboxProviderEnvironmentResponse.DynamicCredentialsEntry
	262, // 195: openshell.v1.GetSandboxProviderEnvironmentResponse.static_credential_bindings:type_name -> openshell.v1.GetSandboxProviderEnvironmentResponse.StaticCredentialBindingsEntry
	3,   // 196: openshell.v1.GetSandboxProviderEnvironmentResponse.readiness_reason:type_name -> openshell.v1.ProviderReadinessReason
	271, // 197: openshell.v1.ExchangeProviderSubjectTokenResponse.expires_after:type_name -> google.protobuf.Duration
	269, // 198: openshell.v1.UpdateConfigRequest.policy:type_name -> openshell.sandbox.v1.SandboxPolicy
	277, // 199: openshell.v1.UpdateConfigRequest.setting_value:type_name -> openshell.sandbox.v1.SettingValue
	158, // 200: openshell.v1.UpdateConfigRequest.merge_operations:type_name -> openshell.v1.PolicyMergeOperation
	263, // 201: openshell.v1.UpdateConfigRequest.annotations:type_name -> openshell.v1.UpdateConfigRequest.AnnotationsEntry
	272, // 202: openshell.v1.UpdateConfigRequest.workspace_scope:type_name -> openshell.datamodel.v1.WorkspaceSelector
	159, // 203: openshell.v1.PolicyMergeOperation.add_rule:type_name -> openshell.v1.AddNetworkRule
	160, // 204: openshell.v1.PolicyMergeOperation.remove_endpoint:type_name -> openshell.v1.RemoveNetworkEndpoint
	161, // 205: openshell.v1.PolicyMergeOperation.remove_rule:type_name -> openshell.v1.RemoveNetworkRule
	163, // 206: openshell.v1.PolicyMergeOperation.add_deny_rules:type_name -> openshell.v1.AddDenyRules
	164, // 207: openshell.v1.PolicyMergeOperation.add_allow_rules:type_name -> openshell.v1.AddAllowRules
	165, // 208: openshell.v1.PolicyMergeOperation.remove_binary:type_name -> openshell.v1.RemoveNetworkBinary
	278, // 209: openshell.v1.AddNetworkRule.rule:type_name -> openshell.sandbox.v1.NetworkPolicyRule
	276, // 210: openshell.v1.L7RuleTarget.binaries:type_name -> openshell.sandbox.v1.NetworkBinary
	279, // 211: openshell.v1.AddDenyRules.deny_rules:type_name -> openshell.sandbox.v1.L7DenyRule
	162, // 212: openshell.v1.AddDenyRules.target:type_name -> openshell.v1.L7RuleTarget
	280, // 213: openshell.v1.AddAllowRules.rules:type_name -> openshell.sandbox.v1.L7Rule
	162, // 214: openshell.v1.AddAllowRules.target:type_name -> openshell.v1.L7RuleTarget
	264, // 215: openshell.v1.UpdateConfigResponse.annotations:type_name -> openshell.v1.UpdateConfigResponse.AnnotationsEntry
	272, // 216: openshell.v1.GetSandboxPolicyStatusRequest.workspace_scope:type_name -> openshell.datamodel.v1.WorkspaceSelector
	176, // 217: openshell.v1.GetSandboxPolicyStatusResponse.revision:type_name -> openshell.v1.SandboxPolicyRevision
	272, // 218: openshell.v1.ListSandboxPoliciesRequest.workspace_scope:type_name -> openshell.datamodel.v1.WorkspaceSelector
	176, // 219: openshell.v1.ListSandboxPoliciesResponse.revisions:type_name -> openshell.v1.SandboxPolicyRevision
	11,  // 220: openshell.v1.ReportPolicyStatusRequest.status:type_name -> openshell.v1.PolicyStatus
	10,  // 221: openshell.v1.SandboxConfigurationAdmission.state:type_name -> openshell.v1.ConfigurationAdmissionState
	173, // 222: openshell.v1.ReportSandboxConfigurationRequest.admission:type_name -> openshell.v1.SandboxConfigurationAdmission
	11,  // 223: openshell.v1.SandboxPolicyRevision.status:type_name -> openshell.v1.PolicyStatus
	267, // 224: openshell.v1.SandboxPolicyRevision.created_time:type_name -> google.protobuf.Timestamp
	267, // 225: openshell.v1.SandboxPolicyRevision.loaded_time:type_name -> google.protobuf.Timestamp
	269, // 226: openshell.v1.SandboxPolicyRevision.policy:type_name -> openshell.sandbox.v1.SandboxPolicy
	265, // 227: openshell.v1.SandboxPolicyRevision.provenance:type_name -> openshell.v1.SandboxPolicyRevision.ProvenanceEntry
	267, // 228: openshell.v1.GetSandboxLogsRequest.since_time:type_name -> google.protobuf.Timestamp
	272, // 229: openshell.v1.GetSandboxLogsRequest.workspace_scope:type_name -> openshell.datamodel.v1.WorkspaceSelector
	109, // 230: openshell.v1.PushSandboxLogsRequest.logs:type_name -> openshell.v1.SandboxLogLine
	109, // 231: openshell.v1.GetSandboxLogsResponse.logs:type_name -> openshell.v1.SandboxLogLine
	183, // 232: openshell.v1.SupervisorMessage.hello:type_name -> openshell.v1.SupervisorHello
	186, // 233: openshell.v1.SupervisorMessage.heartbeat:type_name -> openshell.v1.SupervisorHeartbeat
	197, // 234: openshell.v1.SupervisorMessage.relay_open_result:type_name -> openshell.v1.RelayOpenResult
	198, // 235: openshell.v1.SupervisorMessage.relay_close:type_name -> openshell.v1.RelayClose
	184, // 236: openshell.v1.GatewayMessage.session_accepted:type_name -> openshell.v1.SessionAccepted
	185, // 237: openshell.v1.GatewayMessage.session_rejected:type_name -> openshell.v1.SessionRejected
	187, // 238: openshell.v1.GatewayMessage.heartbeat:type_name -> openshell.v1.GatewayHeartbeat
	192, // 239: openshell.v1.GatewayMessage.relay_open:type_name -> openshell.v1.RelayOpen
	198, // 240: openshell.v1.GatewayMessage.relay_close:type_name -> openshell.v1.RelayClose
	271, // 241: openshell.v1.SessionAccepted.heartbeat_interval:type_name -> google.protobuf.Duration
	193, // 242: openshell.v1.RelayOpen.ssh:type_name -> openshell.v1.SshRelayTarget
	194, // 243: openshell.v1.RelayOpen.tcp:type_name -> openshell.v1.TcpRelayTarget
	195, // 244: openshell.v1.RelayFrame.init:type_name -> openshell.v1.RelayInit
	267, // 245: openshell.v1.DenialSummary.first_seen_time:type_name -> google.protobuf.Timestamp
	267, // 246: openshell.v1.DenialSummary.last_seen_time:type_name -> google.protobuf.Timestamp
	199, // 247: openshell.v1.DenialSummary.l7_request_samples:type_name -> openshell.v1.L7RequestSample
	201, // 248: openshell.v1.NetworkActivitySummary.denials_by_group:type_name -> openshell.v1.DenialGroupCount
	278, // 249: openshell.v1.PolicyChunk.proposed_rule:type_name -> openshell.sandbox.v1.NetworkPolicyRule
	267, // 250: openshell.v1.PolicyChunk.created_time:type_name -> google.protobuf.Timestamp
	267, // 251: openshell.v1.PolicyChunk.decided_time:type_name -> google.protobuf.Timestamp
	267, // 252: openshell.v1.PolicyChunk.first_seen_time:type_name -> google.protobuf.Timestamp
	267, // 253: openshell.v1.PolicyChunk.last_seen_time:type_name -> google.protobuf.Timestamp
	269, // 254: openshell.v1.PolicyChunk.current_effective_policy:type_name -> openshell.sandbox.v1.SandboxPolicy
	269, // 255: openshell.v1.PolicyChunk.candidate_effective_policy:type_name -> openshell.sandbox.v1.SandboxPolicy
	200, // 256: openshell.v1.SubmitPolicyAnalysisRequest.summaries:type_name -> openshell.v1.DenialSummary
	203, // 257: openshell.v1.SubmitPolicyAnalysisRequest.proposed_chunks:type_name -> openshell.v1.PolicyChunk
	202, // 258: openshell.v1.SubmitPolicyAnalysisRequest.network_activity_summaries:type_name -> openshell.v1.NetworkActivitySummary
	272, // 259: openshell.v1.GetDraftPolicyRequest.workspace_scope:type_name -> openshell.datamodel.v1.WorkspaceSelector
	203, // 260: openshell.v1.GetDraftPolicyResponse.chunks:type_name -> openshell.v1.PolicyChunk
	267, // 261: openshell.v1.GetDraftPolicyResponse.last_analyzed_time:type_name -> google.protobuf.Timestamp
	272, // 262: openshell.v1.ApproveDraftChunkRequest.workspace_scope:type_name -> openshell.datamodel.v1.WorkspaceSelector
	272, // 263: openshell.v1.RejectDraftChunkRequest.workspace_scope:type_name -> openshell.datamodel.v1.WorkspaceSelector
	213, // 264: openshell.v1.ApproveAllDraftChunksRequest.approvals:type_name -> openshell.v1.DraftChunkApproval
	272, // 265: openshell.v1.ApproveAllDraftChunksRequest.workspace_scope:type_name -> openshell.datamodel.v1.WorkspaceSelector
	278, // 266: openshell.v1.EditDraftChunkRequest.proposed_rule:type_name -> openshell.sandbox.v1.NetworkPolicyRule
	272, // 267: openshell.v1.EditDraftChunkRequest.workspace_scope:type_name -> openshell.datamodel.v1.WorkspaceSelector
	272, // 268: openshell.v1.UndoDraftChunkRequest.workspace_scope:type_name -> openshell.datamodel.v1.WorkspaceSelector
	272, // 269: openshell.v1.ClearDraftChunksRequest.workspace_scope:type_name -> openshell.datamodel.v1.WorkspaceSelector
	272, // 270: openshell.v1.GetDraftHistoryRequest.workspace_scope:type_name -> openshell.datamodel.v1.WorkspaceSelector
	267, // 271: openshell.v1.DraftHistoryEntry.event_time:type_name -> google.protobuf.Timestamp
	223, // 272: openshell.v1.GetDraftHistoryResponse.entries:type_name -> openshell.v1.DraftHistoryEntry
	266, // 273: openshell.v1.CreateWorkspaceRequest.labels:type_name -> openshell.v1.CreateWorkspaceRequest.LabelsEntry
	281, // 274: openshell.v1.CreateWorkspaceResponse.workspace:type_name -> openshell.datamodel.v1.Workspace
	281, // 275: openshell.v1.GetWorkspaceResponse.workspace:type_name -> openshell.datamodel.v1.Workspace
	281, // 276: openshell.v1.ListWorkspacesResponse.workspaces:type_name -> openshell.datamodel.v1.Workspace
	15,  // 277: openshell.v1.DeleteWorkspaceResponse.outcome:type_name -> openshell.v1.DeletionOutcome
	268, // 278: openshell.v1.WorkspaceMember.metadata:type_name -> openshell.datamodel.v1.ObjectMeta
	...
	233, // 281: openshell.v1.AddWorkspaceMemberResponse.member:type_name -> openshell.v1.WorkspaceMember
	15,  // 282: openshell.v1.RemoveWorkspaceMemberResponse.outcome:type_name -> openshell.v1.DeletionOutcome
	233, // 283: openshell.v1.ListWorkspaceMembersResponse.members:type_name -> openshell.v1.WorkspaceMember
	267, // 284: openshell.v1.ExtensionServiceCredential.expiration_time:type_name -> google.protobuf.Timestamp
	16,  // 285: openshell.v1.EndpointObservation.result:type_name -> openshell.v1.EndpointResult
	241, // 286: openshell.v1.ReportEndpointStatusRequest.observations:type_name -> openshell.v1.EndpointObservation
	16,  // 287: openshell.v1.EndpointStatus.last_result:type_name -> openshell.v1.EndpointResult
	267, // 288: openshell.v1.EndpointStatus.last_reported_time:type_name -> google.protobuf.Timestamp
	267, // 289: openshell.v1.SandboxProvisioning.configuration_change_time:type_name -> google.protobuf.Timestamp
	267, // 290: openshell.v1.SandboxProvisioning.first_rejection_time:type_name -> google.protobuf.Timestamp
	267, // 291: openshell.v1.SandboxProvisioning.deadline:type_name -> google.protobuf.Timestamp
	267, // 292: openshell.v1.SandboxProvisioning.timeout_time:type_name -> google.protobuf.Timestamp
	267, // 293: openshell.v1.SandboxProvisioning.cleanup_completed_time:type_name -> google.protobuf.Timestamp
	267, // 294: openshell.v1.SandboxProvisioning.cleanup_retry_time:type_name -> google.protobuf.Timestamp
	267, // 295: openshell.v1.SandboxProvisioning.attachment_change_time:type_name -> google.protobuf.Timestamp
	267, // 296: openshell.v1.UpdateProviderRequest.CredentialExpirationTimesEntry.value:type_name -> google.protobuf.Timestamp
	267, // 297: openshell.v1.GetSandboxProviderEnvironmentResponse.CredentialExpirationTimesEntry.value:type_name -> google.protobuf.Timestamp
	125, // 298: openshell.v1.GetSandboxProviderEnvironmentResponse.DynamicCredentialsEntry.value:type_name -> openshell.v1.ProviderProfileCredential
	153, // 299: openshell.v1.GetSandboxProviderEnvironmentResponse.StaticCredentialBindingsEntry.value:type_name -> openshell.v1.StaticCredentialBinding
	...
	50,  // 303: openshell.v1.OpenShell.CreateSandbox:input_type -> openshell.v1.CreateSandboxRequest
	58,  // 304: openshell.v1.OpenShell.BeginRootfsTarStaging:input_type -> openshell.v1.BeginRootfsTarStagingRequest
	60,  // 305: openshell.v1.OpenShell.GetSandbox:input_type -> openshell.v1.GetSandboxRequest
	61,  // 306: openshell.v1.OpenShell.ListSandboxes:input_type -> openshell.v1.ListSandboxesRequest
	51,  // 307: openshell.v1.OpenShell.CreateSandboxTemplate:input_type -> openshell.v1.CreateSandboxTemplateRequest
	52,  // 308: openshell.v1.OpenShell.GetSandboxTemplate:input_type -> openshell.v1.GetSandboxTemplateRequest
	53,  // 309: openshell.v1.OpenShell.ListSandboxTemplates:input_type -> openshell.v1.ListSandboxTemplatesRequest
	54,  // 310: openshell.v1.OpenShell.DeleteSandboxTemplate:input_type -> openshell.v1.DeleteSandboxTemplateRequest
	62,  // 311: openshell.v1.OpenShell.ListSandboxProviders:input_type -> openshell.v1.ListSandboxProvidersRequest
	63,  // 312: openshell.v1.OpenShell.AttachSandboxProvider:input_type -> openshell.v1.AttachSandboxProviderRequest
	64,  // 313: openshell.v1.OpenShell.DetachSandboxProvider:input_type -> openshell.v1.DetachSandboxProviderRequest
	80,  // 314: openshell.v1.OpenShell.GetSandboxProviderStatus:input_type -> openshell.v1.GetSandboxProviderStatusRequest
	65,  // 315: openshell.v1.OpenShell.DeleteSandbox:input_type -> openshell.v1.DeleteSandboxRequest
	66,  // 316: openshell.v1.OpenShell.StopSandbox:input_type -> openshell.v1.StopSandboxRequest
	67,  // 317: openshell.v1.OpenShell.StartSandbox:input_type -> openshell.v1.StartSandboxRequest
	85,  // 318: openshell.v1.OpenShell.CreateSshSession:input_type -> openshell.v1.CreateSshSessionRequest
	87,  // 319: openshell.v1.OpenShell.ExposeService:input_type -> openshell.v1.ExposeServiceRequest
	88,  // 320: openshell.v1.OpenShell.GetService:input_type -> openshell.v1.GetServiceRequest
	89,  // 321: openshell.v1.OpenShell.ListServices:input_type -> openshell.v1.ListServicesRequest
	91,  // 322: openshell.v1.OpenShell.DeleteService:input_type -> openshell.v1.DeleteServiceRequest
	95,  // 323: openshell.v1.OpenShell.RevokeSshSession:input_type -> openshell.v1.RevokeSshSessionRequest
	97,  // 324: openshell.v1.OpenShell.ExecSandbox:input_type -> openshell.v1.ExecSandboxRequest
	103, // 325: openshell.v1.OpenShell.ForwardTcp:input_type -> openshell.v1.TcpForwardFrame
	104, // 326: openshell.v1.OpenShell.ExecSandboxInteractive:input_type -> openshell.v1.ExecSandboxInput
	111, // 327: openshell.v1.OpenShell.CreateProvider:input_type -> openshell.v1.CreateProviderRequest
	112, // 328: openshell.v1.OpenShell.GetProvider:input_type -> openshell.v1.GetProviderRequest
	113, // 329: openshell.v1.OpenShell.ListProviders:input_type -> openshell.v1.ListProvidersRequest
	118, // 330: openshell.v1.OpenShell.ListProviderProfiles:input_type -> openshell.v1.ListProviderProfilesRequest
	119, // 331: openshell.v1.OpenShell.GetProviderProfile:input_type -> openshell.v1.GetProviderProfileRequest
	142, // 332: openshell.v1.OpenShell.ImportProviderProfiles:input_type -> openshell.v1.ImportProviderProfilesRequest
	144, // 333: openshell.v1.OpenShell.UpdateProviderProfiles:input_type -> openshell.v1.UpdateProviderProfilesRequest
	146, // 334: openshell.v1.OpenShell.LintProviderProfiles:input_type -> openshell.v1.LintProviderProfilesRequest
	114, // 335: openshell.v1.OpenShell.UpdateProvider:input_type -> openshell.v1.UpdateProviderRequest
	131, // 336: openshell.v1.OpenShell.GetProviderRefreshStatus:input_type -> openshell.v1.GetProviderRefreshStatusRequest
	133, // 337: openshell.v1.OpenShell.ConfigureProviderRefresh:input_type -> openshell.v1.ConfigureProviderRefreshRequest
	135, // 338: openshell.v1.OpenShell.RotateProviderCredential:input_type -> openshell.v1.RotateProviderCredentialRequest
	137, // 339: openshell.v1.OpenShell.DeleteProviderRefresh:input_type -> openshell.v1.DeleteProviderRefreshRequest
	115, // 340: openshell.v1.OpenShell.DeleteProvider:input_type -> openshell.v1.DeleteProviderRequest
	149, // 341: openshell.v1.OpenShell.DeleteProviderProfile:input_type -> openshell.v1.DeleteProviderProfileRequest
	282, // 342: openshell.v1.OpenShell.GetSandboxConfig:input_type -> openshell.sandbox.v1.GetSandboxConfigRequest
	283, // 343: openshell.v1.OpenShell.GetGatewayConfig:input_type -> openshell.sandbox.v1.GetGatewayConfigRequest
	157, // 344: openshell.v1.OpenShell.UpdateConfig:input_type -> openshell.v1.UpdateConfigRequest
	167, // 345: openshell.v1.OpenShell.GetSandboxPolicyStatus:input_type -> openshell.v1.GetSandboxPolicyStatusRequest
	169, // 346: openshell.v1.OpenShell.ListSandboxPolicies:input_type -> openshell.v1.ListSandboxPoliciesRequest
	171, // 347: openshell.v1.OpenShell.ReportPolicyStatus:input_type -> openshell.v1.ReportPolicyStatusRequest
	242, // 348: openshell.v1.OpenShell.ReportEndpointStatus:input_type -> openshell.v1.ReportEndpointStatusRequest
	82,  // 349: openshell.v1.OpenShell.ReportProviderReadiness:input_type -> openshell.v1.ReportProviderReadinessRequest
	174, // 350: openshell.v1.OpenShell.ReportSandboxConfiguration:input_type -> openshell.v1.ReportSandboxConfigurationRequest
	151, // 351: openshell.v1.OpenShell.GetSandboxProviderEnvironment:input_type -> openshell.v1.GetSandboxProviderEnvironmentRequest
	155, // 352: openshell.v1.OpenShell.ExchangeProviderSubjectToken:input_type -> openshell.v1.ExchangeProviderSubjectTokenRequest
	177, // 353: openshell.v1.OpenShell.GetSandboxLogs:input_type -> openshell.v1.GetSandboxLogsRequest
	178, // 354: openshell.v1.OpenShell.PushSandboxLogs:input_type -> openshell.v1.PushSandboxLogsRequest
	181, // 355: openshell.v1.OpenShell.ConnectSupervisor:input_type -> openshell.v1.SupervisorMessage
	188, // 356: openshell.v1.OpenShell.ReportMainProcessExit:input_type -> openshell.v1.ReportMainProcessExitRequest
	190, // 357: openshell.v1.OpenShell.FinalizeMainProcessExit:input_type -> openshell.v1.FinalizeMainProcessExitRequest
	196, // 358: openshell.v1.OpenShell.RelayStream:input_type -> openshell.v1.RelayFrame
	107, // 359: openshell.v1.OpenShell.WatchSandbox:input_type -> openshell.v1.WatchSandboxRequest
	205, // 360: openshell.v1.OpenShell.SubmitPolicyAnalysis:input_type -> openshell.v1.SubmitPolicyAnalysisRequest
	207, // 361: openshell.v1.OpenShell.GetDraftPolicy:input_type -> openshell.v1.GetDraftPolicyRequest
	209, // 362: openshell.v1.OpenShell.ApproveDraftChunk:input_type -> openshell.v1.ApproveDraftChunkRequest
	211, // 363: openshell.v1.OpenShell.RejectDraftChunk:input_type -> openshell.v1.RejectDraftChunkRequest
	214, // 364: openshell.v1.OpenShell.ApproveAllDraftChunks:input_type -> openshell.v1.ApproveAllDraftChunksRequest
	216, // 365: openshell.v1.OpenShell.EditDraftChunk:input_type -> openshell.v1.EditDraftChunkRequest
	218, // 366: openshell.v1.OpenShell.UndoDraftChunk:input_type -> openshell.v1.UndoDraftChunkRequest
	220, // 367: openshell.v1.OpenShell.ClearDraftChunks:input_type -> openshell.v1.ClearDraftChunksRequest
	222, // 368: openshell.v1.OpenShell.GetDraftHistory:input_type -> openshell.v1.GetDraftHistoryRequest
	...
	225, // 371: openshell.v1.OpenShell.CreateWorkspace:input_type -> openshell.v1.CreateWorkspaceRequest
	227, // 372: openshell.v1.OpenShell.GetWorkspace:input_type -> openshell.v1.GetWorkspaceRequest
	229, // 373: openshell.v1.OpenShell.ListWorkspaces:input_type -> openshell.v1.ListWorkspacesRequest
	231, // 374: openshell.v1.OpenShell.DeleteWorkspace:input_type -> openshell.v1.DeleteWorkspaceRequest
	234, // 375: openshell.v1.OpenShell.AddWorkspaceMember:input_type -> openshell.v1.AddWorkspaceMemberRequest
	236, // 376: openshell.v1.OpenShell.RemoveWorkspaceMember:input_type -> openshell.v1.RemoveWorkspaceMemberRequest
	238, // 377: openshell.v1.OpenShell.ListWorkspaceMembers:input_type -> openshell.v1.ListWorkspaceMembersRequest
	...
	68,  // 381: openshell.v1.OpenShell.CreateSandbox:output_type -> openshell.v1.SandboxResponse
	59,  // 382: openshell.v1.OpenShell.BeginRootfsTarStaging:output_type -> openshell.v1.BeginRootfsTarStagingResponse
	68,  // 383: openshell.v1.OpenShell.GetSandbox:output_type -> openshell.v1.SandboxResponse
	69,  // 384: openshell.v1.OpenShell.ListSandboxes:output_type -> openshell.v1.ListSandboxesResponse
	55,  // 385: openshell.v1.OpenShell.CreateSandboxTemplate:output_type -> openshell.v1.SandboxTemplateResponse
	55,  // 386: openshell.v1.OpenShell.GetSandboxTemplate:output_type -> openshell.v1.SandboxTemplateResponse
	56,  // 387: openshell.v1.OpenShell.ListSandboxTemplates:output_type -> openshell.v1.ListSandboxTemplatesResponse
	57,  // 388: openshell.v1.OpenShell.DeleteSandboxTemplate:output_type -> openshell.v1.DeleteSandboxTemplateResponse
	70,  // 389: openshell.v1.OpenShell.ListSandboxProviders:output_type -> openshell.v1.ListSandboxProvidersResponse
	71,  // 390: openshell.v1.OpenShell.AttachSandboxProvider:output_type -> openshell.v1.AttachSandboxProviderResponse
	72,  // 391: openshell.v1.OpenShell.DetachSandboxProvider:output_type -> openshell.v1.DetachSandboxProviderResponse
	81,  // 392: openshell.v1.OpenShell.GetSandboxProviderStatus:output_type -> openshell.v1.GetSandboxProviderStatusResponse
	84,  // 393: openshell.v1.OpenShell.DeleteSandbox:output_type -> openshell.v1.DeleteSandboxResponse
	68,  // 394: openshell.v1.OpenShell.StopSandbox:output_type -> openshell.v1.SandboxResponse
	68,  // 395: openshell.v1.OpenShell.StartSandbox:output_type -> openshell.v1.SandboxResponse
	86,  // 396: openshell.v1.OpenShell.CreateSshSession:output_type -> openshell.v1.CreateSshSessionResponse
	94,  // 397: openshell.v1.OpenShell.ExposeService:output_type -> openshell.v1.ServiceEndpointResponse
	94,  // 398: openshell.v1.OpenShell.GetService:output_type -> openshell.v1.ServiceEndpointResponse
	90,  // 399: openshell.v1.OpenShell.ListServices:output_type -> openshell.v1.ListServicesResponse
	92,  // 400: openshell.v1.OpenShell.DeleteService:output_type -> openshell.v1.DeleteServiceResponse
	96,  // 401: openshell.v1.OpenShell.RevokeSshSession:output_type -> openshell.v1.RevokeSshSessionResponse
	101, // 402: openshell.v1.OpenShell.ExecSandbox:output_type -> openshell.v1.ExecSandboxEvent
	103, // 403: openshell.v1.OpenShell.ForwardTcp:output_type -> openshell.v1.TcpForwardFrame
	101, // 404: openshell.v1.OpenShell.ExecSandboxInteractive:output_type -> openshell.v1.ExecSandboxEvent
	116, // 405: openshell.v1.OpenShell.CreateProvider:output_type -> openshell.v1.ProviderResponse
	116, // 406: openshell.v1.OpenShell.GetProvider:output_type -> openshell.v1.ProviderResponse
	117, // 407: openshell.v1.OpenShell.ListProviders:output_type -> openshell.v1.ListProvidersResponse
	141, // 408: openshell.v1.OpenShell.ListProviderProfiles:output_type -> openshell.v1.ListProviderProfilesResponse
	140, // 409: openshell.v1.OpenShell.GetProviderProfile:output_type -> openshell.v1.ProviderProfileResponse
	143, // 410: openshell.v1.OpenShell.ImportProviderProfiles:output_type -> openshell.v1.ImportProviderProfilesResponse
	145, // 411: openshell.v1.OpenShell.UpdateProviderProfiles:output_type -> openshell.v1.UpdateProviderProfilesResponse
	147, // 412: openshell.v1.OpenShell.LintProviderProfiles:output_type -> openshell.v1.LintProviderProfilesResponse
	116, // 413: openshell.v1.OpenShell.UpdateProvider:output_type -> openshell.v1.ProviderResponse
	132, // 414: openshell.v1.OpenShell.GetProviderRefreshStatus:output_type -> openshell.v1.GetProviderRefreshStatusResponse
	134, // 415: openshell.v1.OpenShell.ConfigureProviderRefresh:output_type -> openshell.v1.ConfigureProviderRefreshResponse
	136, // 416: openshell.v1.OpenShell.RotateProviderCredential:output_type -> openshell.v1.RotateProviderCredentialResponse
	138, // 417: openshell.v1.OpenShell.DeleteProviderRefresh:output_type -> openshell.v1.DeleteProviderRefreshResponse
	148, // 418: openshell.v1.OpenShell.DeleteProvider:output_type -> openshell.v1.DeleteProviderResponse
	150, // 419: openshell.v1.OpenShell.DeleteProviderProfile:output_type -> openshell.v1.DeleteProviderProfileResponse
	284, // 420: openshell.v1.OpenShell.GetSandboxConfig:output_type -> openshell.sandbox.v1.GetSandboxConfigResponse
	285, // 421: openshell.v1.OpenShell.GetGatewayConfig:output_type -> openshell.sandbox.v1.GetGatewayConfigResponse
	166, // 422: openshell.v1.OpenShell.UpdateConfig:output_type -> openshell.v1.UpdateConfigResponse
	168, // 423: openshell.v1.OpenShell.GetSandboxPolicyStatus:output_type -> openshell.v1.GetSandboxPolicyStatusResponse
	170, // 424: openshell.v1.OpenShell.ListSandboxPolicies:output_type -> openshell.v1.ListSandboxPoliciesResponse
	172, // 425: openshell.v1.OpenShell.ReportPolicyStatus:output_type -> openshell.v1.ReportPolicyStatusResponse
	243, // 426: openshell.v1.OpenShell.ReportEndpointStatus:output_type -> openshell.v1.ReportEndpointStatusResponse
	83,  // 427: openshell.v1.OpenShell.ReportProviderReadiness:output_type -> openshell.v1.ReportProviderReadinessResponse
	175, // 428: openshell.v1.OpenShell.ReportSandboxConfiguration:output_type -> openshell.v1.ReportSandboxConfigurationResponse
	154, // 429: openshell.v1.OpenShell.GetSandboxProviderEnvironment:output_type -> openshell.v1.GetSandboxProviderEnvironmentResponse
	156, // 430: openshell.v1.OpenShell.ExchangeProviderSubjectToken:output_type -> openshell.v1.ExchangeProviderSubjectTokenResponse
	180, // 431: openshell.v1.OpenShell.GetSandboxLogs:output_type -> openshell.v1.GetSandboxLogsResponse
	179, // 432: openshell.v1.OpenShell.PushSandboxLogs:output_type -> openshell.v1.PushSandboxLogsResponse
	182, // 433: openshell.v1.OpenShell.ConnectSupervisor:output_type -> openshell.v1.GatewayMessage
	189, // 434: openshell.v1.OpenShell.ReportMainProcessExit:output_type -> openshell.v1.ReportMainProcessExitResponse
	191, // 435: openshell.v1.OpenShell.FinalizeMainProcessExit:output_type -> openshell.v1.FinalizeMainProcessExitResponse
	196, // 436: openshell.v1.OpenShell.RelayStream:output_type -> openshell.v1.RelayFrame
	108, // 437: openshell.v1.OpenShell.WatchSandbox:output_type -> openshell.v1.SandboxStreamEvent
	206, // 438: openshell.v1.OpenShell.SubmitPolicyAnalysis:output_type -> openshell.v1.SubmitPolicyAnalysisResponse
	208, // 439: openshell.v1.OpenShell.GetDraftPolicy:output_type -> openshell.v1.GetDraftPolicyResponse
	210, // 440: openshell.v1.OpenShell.ApproveDraftChunk:output_type -> openshell.v1.ApproveDraftChunkResponse
	212, // 441: openshell.v1.OpenShell.RejectDraftChunk:output_type -> openshell.v1.RejectDraftChunkResponse
	215, // 442: openshell.v1.OpenShell.ApproveAllDraftChunks:output_type -> openshell.v1.ApproveAllDraftChunksResponse
	217, // 443: openshell.v1.OpenShell.EditDraftChunk:output_type -> openshell.v1.EditDraftChunkResponse
	219, // 444: openshell.v1.OpenShell.UndoDraftChunk:output_type -> openshell.v1.UndoDraftChunkResponse
	221, // 445: openshell.v1.OpenShell.ClearDraftChunks:output_type -> openshell.v1.ClearDraftChunksResponse
	224, // 446: openshell.v1.OpenShell.GetDraftHistory:output_type -> openshell.v1.GetDraftHistoryResponse
	...
	226, // 449: openshell.v1.OpenShell.CreateWorkspace:output_type -> openshell.v1.CreateWorkspaceResponse
	228, // 450: openshell.v1.OpenShell.GetWorkspace:output_type -> openshell.v1.GetWorkspaceResponse
	230, // 451: openshell.v1.OpenShell.ListWorkspaces:output_type -> openshell.v1.ListWorkspacesResponse
	232, // 452: openshell.v1.OpenShell.DeleteWorkspace:output_type -> openshell.v1.DeleteWorkspaceResponse
	235, // 453: openshell.v1.OpenShell.AddWorkspaceMember:output_type -> openshell.v1.AddWorkspaceMemberResponse
	237, // 454: openshell.v1.OpenShell.RemoveWorkspaceMember:output_type -> openshell.v1.RemoveWorkspaceMemberResponse
	239, // 455: openshell.v1.OpenShell.ListWorkspaceMembers:output_type -> openshell.v1.ListWorkspaceMembersResponse
