...
var file_openshell_proto_goTypes = []any{
	...
	(*policyv1.PolicyDocument)(nil),                      // 269: openshell.policy.v1.PolicyDocument
	...
	(*policyv1.NetworkEndpoint)(nil),                     // 275: openshell.policy.v1.NetworkEndpoint
	(*policyv1.NetworkBinary)(nil),                       // 276: openshell.policy.v1.NetworkBinary
	(*sandboxv1.SettingValue)(nil),                       // 277: openshell.sandbox.v1.SettingValue
	(*policyv1.NetworkPolicyRule)(nil),                   // 278: openshell.policy.v1.NetworkPolicyRule
	(*policyv1.L7DenyRule)(nil),                          // 279: openshell.policy.v1.L7DenyRule
	(*policyv1.L7Rule)(nil),                              // 280: openshell.policy.v1.L7Rule
...
var file_openshell_proto_depIdxs = []int32{
	...
	269, // 18: openshell.v1.SandboxSpec.policy:type_name -> openshell.policy.v1.PolicyDocument
	...
	275, // 179: openshell.v1.ProviderProfile.endpoints:type_name -> openshell.policy.v1.NetworkEndpoint
	276, // 180: openshell.v1.ProviderProfile.binaries:type_name -> openshell.policy.v1.NetworkBinary
	...
	269, // 207: openshell.v1.UpdateConfigRequest.policy:type_name -> openshell.policy.v1.PolicyDocument
	...
	278, // 217: openshell.v1.AddNetworkRule.rule:type_name -> openshell.policy.v1.NetworkPolicyRule
	276, // 218: openshell.v1.L7RuleTarget.binaries:type_name -> openshell.policy.v1.NetworkBinary
	279, // 219: openshell.v1.AddDenyRules.deny_rules:type_name -> openshell.policy.v1.L7DenyRule
	160, // 220: openshell.v1.AddDenyRules.target:type_name -> openshell.v1.L7RuleTarget
	280, // 221: openshell.v1.AddAllowRules.rules:type_name -> openshell.policy.v1.L7Rule
	...
	269, // 234: openshell.v1.SandboxPolicyRevision.policy:type_name -> openshell.policy.v1.PolicyDocument
	...
	278, // 257: openshell.v1.PolicyChunk.proposed_rule:type_name -> openshell.policy.v1.NetworkPolicyRule
	...
	269, // 262: openshell.v1.PolicyChunk.current_effective_policy:type_name -> openshell.policy.v1.PolicyDocument
	269, // 263: openshell.v1.PolicyChunk.candidate_effective_policy:type_name -> openshell.policy.v1.PolicyDocument
	...
	278, // 276: openshell.v1.EditDraftChunkRequest.proposed_rule:type_name -> openshell.policy.v1.NetworkPolicyRule
