...
def _make_workload_template_proto(
    ...
    *,
    ...
    template.spec.workload.resources.cpu.quantity = "1"
    template.spec.workload.resources.memory.quantity = "512Mi"
    return template
...
def test_sandbox_template_create_builds_template_from_public_fields() -> None:
    ...
    assert template.spec.workload.resources.cpu.quantity == "1"
    assert template.spec.workload.resources.memory.quantity == "512Mi"
